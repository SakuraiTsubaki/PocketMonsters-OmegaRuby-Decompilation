# Milestones: Pocket Monsters Omega Ruby

This roadmap governs research, tooling, analysis, reconstruction, and preservation for `SakuraiTsubaki/PocketMonsters-OmegaRuby-Decompilation`.
...
| Field | Current value |
| --- | --- |
| Target | Pocket Monsters Omega Ruby |
...
- Identified input manifest; container metadata; ExHeader, ExeFS, RomFS, code, module/CRO, compression, and update-content inventories.
...
- ARM11 executable and module maps; functions, call edges, relocations, symbols, data references, compiler fingerprints, and confidence records.
...
- RomFS formats, tables, scripts, models, textures, UI, graphics, fonts, audio, localization, and converters with manifests and PNG previews.
...
Coordinate format findings with Alpha Sapphire and promote reusable Nintendo 3DS tooling to the common repository.
