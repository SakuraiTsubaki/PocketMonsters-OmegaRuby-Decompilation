...
- Differences are recorded directionally as `Japanese baseline → target region/language/revision`, while Omega Ruby↔Alpha Sapphire differences remain a separate comparison axis.
...
4. Version-exclusive Omega Ruby versus Alpha Sapphire behavior/data.
