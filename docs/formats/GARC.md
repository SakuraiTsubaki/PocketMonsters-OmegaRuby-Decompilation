...
Status: **public-source reconstruction; retail Pokémon Omega Ruby dump not yet available for direct verification**
...
Without a Pokémon Omega Ruby source dump, the following remain unverified here:

- exact raw magic bytes in a retail Omega Ruby archive
- whether all retail Omega Ruby GARCs use identical padding behavior
...
7. When a lawful Pokémon Omega Ruby dump becomes available, verify parse → repack behavior and record hashes/revision metadata without committing the ROM itself.
...
- Pokémon Omega Ruby path inventory: **blocked pending source dump**
