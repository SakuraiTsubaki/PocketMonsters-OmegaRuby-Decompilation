...
class FunctionManifestTests(unittest.TestCase):
    def test_provisional_names_and_sorting(self):
    ...
    def test_rejects_invalid_status(self):
        with self.assertRaises(ValueError): normalize([{"address":0x1000,"size":4,"status":"guessed"}])
    def test_reports_outside_text_range(self):
