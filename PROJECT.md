# Target Profile: Pocket Monsters Omega Ruby

## Known repository scope

- Repository: `SakuraiTsubaki/PocketMonsters-OmegaRuby-Decompilation`
- Working target name: Pocket Monsters Omega Ruby
