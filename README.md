...
A complete, target-specific workspace for reproducible research, analysis, tooling, source reconstruction, and retained non-ROM work products related to **Pocket Monsters Omega Ruby**.

| Field | Value |
| --- | --- |
| Working target | Pocket Monsters Omega Ruby |
