# Pocket Monsters Omega Ruby — Decompilation
...
Decompilation and source-reconstruction project for **Pokémon Omega Ruby**.
...
- Omega Ruby / Alpha Sapphire and broader Generation VI cross-title comparison after independent verification
...
Findings must identify the relevant target version or revision and clearly separate hypotheses from observed, reproduced, or matched results. Structures are promoted to **ORAS common** or **Generation VI common** only after independent confirmation in the relevant games.
